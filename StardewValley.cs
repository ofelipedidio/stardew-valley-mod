...
public class Game1 : InstanceGame
{
	...
	public static StardewValley.Object dishOfTheDay
	{
		get
		{
	...
	public static void fixProblems()
	{
		...
		foreach (Farmer player in getAllFarmers())
		{
			if (player.hasQuest("130"))
			{
				...
				if (!found)
				{
					StardewValley.Object item = ItemRegistry.Create<StardewValley.Object>("(O)864");
	...
	public static void UpdateDishOfTheDay()
	{
		...
		dishOfTheDay = ItemRegistry.Create<StardewValley.Object>("(O)" + itemId, count);
	}
	...
	public static void UpdateShopPlayerItemInventory(string location_name, HashSet<NPC> purchased_item_npcs)
	{
		...
		{
			if (!(items[i] is StardewValley.Object item))
			{
				items.RemoveAt(i);
			}
			else
	...
	public static void setGraphicsForSeason(bool onLoad = false)
	{
		foreach (GameLocation l in locations)
		{
			...
			case Season.Spring:
				...
				break;
			case Season.Summer:
				foreach (StardewValley.Object o3 in l.Objects.Values)
				{
					if (!o3.IsWeeds())
					{
						continue;
				...
				break;
			case Season.Fall:
				foreach (StardewValley.Object o2 in l.Objects.Values)
				{
					if (o2.IsWeeds())
					{
			...
			case Season.Winter:
			{
				KeyValuePair<Vector2, StardewValley.Object>[] array = l.Objects.Pairs.ToArray();
				for (int i = 0; i < array.Length; i++)
				{
					KeyValuePair<Vector2, StardewValley.Object> pair = array[i];
					StardewValley.Object o = pair.Value;
					if (o.IsWeeds())
					{
	...
	public static void warpFarmer(LocationRequest locationRequest, int tileX, int tileY, int facingDirectionAfterWarp)
	{
		...
		case "Farm":
			...
			case "FarmCave":
			{
				...
				if (getFarm().TryGetMapPropertyAs("FarmCaveEntry", out Point tile3, required: false))
				{
					tileX = tile3.X;
					tileY = tile3.Y;
					break;
			...
			case "Forest":
			{
				...
				if (getFarm().TryGetMapPropertyAs("ForestEntry", out Point tile4, required: false))
				{
					tileX = tile4.X;
					tileY = tile4.Y;
					break;
			...
			case "BusStop":
			{
				if (tileX == 79 && tileY == 17 && getFarm().TryGetMapPropertyAs("BusStopEntry", out Point tile2, required: false))
				{
					tileX = tile2.X;
					tileY = tile2.Y;
				}
	...
	public static bool CanPlayerStowItem(Vector2 position)
	{
		...
		StardewValley.Object activeObject = player.ActiveObject;
	...
	protected virtual void drawHUD()
	{
		...
		foreach (KeyValuePair<Vector2, StardewValley.Object> v in currentLocation.objects.Pairs)
		{
	...
	protected virtual bool _RecursiveRemoveThisNormalItemItem(Item this_item, string itemId)
	{
		if (this_item != null)
		{
			if (this_item is StardewValley.Object o)
			{
	...
	protected virtual void _RecursiveRemoveThisNormalItemLocation(GameLocation l, string itemId)
	{
		...
		{
			StardewValley.Object obj = l.objects[key];
